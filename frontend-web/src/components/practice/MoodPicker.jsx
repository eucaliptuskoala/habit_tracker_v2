function MoodIcon({ mood, size = 32 }) {
  ...
  if (mood === "AWFUL")
    return (
      <svg viewBox="0 0 32 32" width={s} height={s} fill="none">
        ...
        <path d="M11.5 22c2-1.5 6-1.5 8 0" stroke="oklch(55% 0.08 250)" strokeWidth="1.2" fill="none" />
  ...
  if (mood === "BAD")
    return (
      <svg viewBox="0 0 32 32" width={s} height={s} fill="none">
        ...
        <path d="M11.5 21c2-1 6-1 8 0" stroke="oklch(62% 0.07 220)" strokeWidth="1.2" fill="none" />
  ...
  if (mood === "OKAY")
    return (
      <svg viewBox="0 0 32 32" width={s} height={s} fill="none">
        ...
        <ellipse cx="12" cy="13" rx="2" ry="2.5" fill="oklch(67% 0.06 110)" opacity="0.35" />
        <ellipse cx="20" cy="13" rx="2" ry="2.5" fill="oklch(67% 0.06 110)" opacity="0.35" />
        <path d="M11.5 20c2 1.5 6 1.5 8 0" stroke="oklch(67% 0.06 110)" strokeWidth="1.2" fill="none" />
      </svg>
    );
  if (mood === "GOOD")
    return (
      <svg viewBox="0 0 32 32" width={s} height={s} fill="none">
        ...
        <ellipse cx="12" cy="13" rx="2" ry="2" fill="oklch(72% 0.12 80)" />
        <ellipse cx="20" cy="13" rx="2" ry="2" fill="oklch(72% 0.12 80)" />
        <path d="M11.5 19c2 2 6 2 8 0" stroke="oklch(72% 0.12 80)" strokeWidth="1.3" fill="none" />
  ...
  if (mood === "AWESOME")
    return (
      <svg viewBox="0 0 32 32" width={s} height={s} fill="none">
        <circle cx="16" cy="16" r="13" fill="oklch(90% 0.18 80)" />
        <circle cx="16" cy="16" r="11" fill="oklch(78% 0.18 75)" opacity="0.3" />
        <ellipse cx="12" cy="13" rx="2" ry="2" fill="oklch(78% 0.18 75)" />
        <ellipse cx="20" cy="13" rx="2" ry="2" fill="oklch(78% 0.18 75)" />
        <path d="M11.5 18c2 3 6 3 8 0" stroke="oklch(78% 0.18 75)" strokeWidth="1.5" fill="none" strokeLinecap="round" />
        <path d="M24 7l2 2-2 2" stroke="oklch(78% 0.18 75)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M27 7l2 2-2 2" stroke="oklch(78% 0.18 75)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M30 7l2 2-2 2" stroke="oklch(78% 0.18 75)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  return null;
}
