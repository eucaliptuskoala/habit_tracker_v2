...
class GetAllHabitTemplatesUseCaseImplTest {

    @Mock
    private IHabitTemplateRepository repository;

    @InjectMocks
    private GetAllHabitTemplatesUseCaseImpl getAllHabitTemplatesUseCaseImpl;
    ...
    void getAllHabitTemplates_success() {
        ...
        List<HabitTemplate> retrievedTemplates = getAllHabitTemplatesUseCaseImpl.getAllHabitTemplates();

        assertEquals(11, retrievedTemplates.size());
        assertEquals(11, retrievedTemplates.get(0).getPopularity());
        assertEquals(10, retrievedTemplates.get(1).getPopularity());
        assertEquals(9, retrievedTemplates.get(2).getPopularity());
